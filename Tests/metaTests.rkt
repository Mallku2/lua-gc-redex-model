...
(define (meta-test-suite)
  ...
  (test-->> meta
            (term ((((cl 1) (function X () ($statFunCall (ref 1) ()) end))
                    ((objr 1) ((\{ (\[ "__call" \] = (cl 1)) \}) nil 0))) 
                   : ((1 (2))WrongFunCall)))
  ...
  (test-->> meta
            (term ((((objr 1) 
                     ((\{ (\[ 1 \] = 1) \}) (objr 2) 0))
                    ((cl 1) (function X () ($statFunCall (ref 1) ()) end))
                    ((objr 2) 
                     ((\{ (\[ "__index" \] = (cl 1)) \}) nil 0))) 
                   : (((objr 1) \[ 2 \]) WrongKey)))
  ...
  (test-->> meta
            ...
            (term
             (()
              :
              ($builtIn error ("attempt to concatenate a number value.")))))
  ...
  (test-->> meta
            ...
            (term
             (()
              :
              ($builtIn error ("attempt to compare string with number")))))
...
; E-FieldAssignWrongKeyNormal
  ...
  (test-->> meta
            (term ((((cl 1) (function X () ($statFunCall (ref 1) ()) end))
                    ((objr 1) 
                     ((\{ (\[ "__newindex" \] = (cl 1)) \}) nil 0)))
                   : (((1 \[ 2 \]) = 2)NonTable)))
            
            (term ((((cl 1) (function X () ($statFunCall (ref 1) ()) end))
                    ((objr 1) 
                     ((\{ (\[ "__newindex" \] = (cl 1)) \}) nil 0)))
                   : ($statFunCall (cl 1) (1 2 2)))))
